...
import assets from "../assets/assets"; // สมมติว่า assets.bgImage1 มีอยู่จริง
import Title from "../components/Title"; // สมมติว่า Title component มีอยู่จริง

// Star Rating Component (ไม่มีการเปลี่ยนแปลง)
...
export default function Feedback() {
  ...
  return (
    <main className="card-wrap" style={{ position: 'relative' }}>
      {/* Background images positioned absolutely - เหมือนกับ admission */}
      <img 
        src={assets.bgImage1} 
        alt="" 
